	...
	<div class="breadcrumb-agile">
		<ol class="breadcrumb m-0">
			<li class="breadcrumb-item">
				<a href="index.php">Mess bill Receipt</a>
			</li>
		</ol>
	</div>
	<!-- //page details -->
	...
	<section class="contact-wthree py-5" id="contact">
		<div class="container py-xl-5 py-lg-3">
			<div class="title text-center mb-sm-5 mb-4">
				<h3 class="title-w3 text-bl text-center font-weight-bold">Mess bill Receipt</h3>
				<div class="arrw">
...
<div class="card-body">
	<div class="row mb-4">
			<div class="col-sm-12">
				<center>
				<h2>Ajay Kumar Garg Engineering College (AKGEC)</h2>
...
?>
			<div class="col-sm-12">
				<div style="font-size:16px;"><b>Received from Miss.  <u ><?php echo $rshosteller['name']; ?></u> Collected Amount <u >Rs.<?php echo $rsbilling[4]; ?></u>  from <u ><?php echo date("01-M-Y",strtotime($_GET['month'])); ?></u>  to <u ><?php echo date("31-M-Y",strtotime($_GET['month'])); ?></u></b></div>
			</div>
<?php
}
else
...
<table class="table">
	...
	<tr>
		...
		<td class="right"><?php echo $currencysymbol; ?><?php echo $rs[3]; ?></td>
	</tr>
	<tr>
		<td class="left">Mess Bill</td>
		<td class="right"><?php echo $currencysymbol; ?><?php echo $rs[4]; ?></td>
	</tr>
	<tr>
		<td class="left">Water & Electricity Charge</td>
		<td class="right"><?php echo $currencysymbol; ?><?php echo $rs[5]; ?></td>
	</tr>
	<tr>
		<td class="left">Maintanance Charge</td>
		<td class="right"><?php echo $currencysymbol; ?><?php echo $rs[6]; ?></td>
	</tr>
	<tr>
		<td class="left">Penalty</td>
		<td class="right"><?php echo $currencysymbol; ?><?php echo $rs[8]; ?></td>
	</tr>

	<tr>
		<th class="left">Total Cost</th>
		<th class="right"><?php echo $currencysymbol; ?><?php echo $rs[3]+$rs[4]+$rs[5]+$rs[6]+$rs[8]; ?></th>
	</tr>
	</tbody>
</table>
</div>
