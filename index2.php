            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4 img-container">
                  <div class="img-box">
                    <img src="images_1/slider-img.png" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="experience_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="img-box">
            <img src="images_1/experience-img.jpg" alt="">
          </div>
        </div>
        <div class="col-md-7">
          <div class="detail-box">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-lg-9 mx-auto">
          <div class="img-box">
            <img src="images_1/about-img.jpg" alt="">
          </div>
        </div>
      </div>
      <div class="detail-box">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="collapse show" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordion">
              <div class="img-box">
                <img src="images_1/freelance-img.jpg" alt="">
              </div>
            </div>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="detail-box">
                  ...
                  <img src="images_1/quote.png" alt="">
                </div>
              </div>
              <div class="carousel-item">
                <div class="detail-box">
      ...
      <div class="container">
        <div class="info_top">
          ...
          <div class="social_box">
            <a href="#">
              <img src="images_1/fb.png" alt="">
            </a>
            <a href="#">
              <img src="images_1/twitter.png" alt="">
            </a>
            <a href="#">
              <img src="images_1/linkedin.png" alt="">
            </a>
            <a href="#">
              <img src="images_1/instagram.png" alt="">
            </a>
            <a href="#">
              <img src="images_1/youtube.png" alt="">
            </a>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-3">
                  <a href="#" class="link-box">
                    <div class="img-box">
                      <img src="images_1/location.png" alt="">
                    </div>
                    <div class="detail-box">
                      <h6>
                        Location
