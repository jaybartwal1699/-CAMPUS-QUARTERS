...
<br>
			...
			<div class="col-sm-12">
			<div style="font-size:16px;"><b>Received from Miss.  <u ><?php echo $rsadmission['name']; ?></u> Collected Amount <u ><?php echo $currencysymbol; ?><?php echo $rsbilling[4]; ?></u>  from <u><?php echo date("d-M-Y",strtotime($particulars[0])); ?></u>  to <u ><?php echo date("d-M-Y",strtotime($particulars[1])); ?></u></b></div>
			</div>
	</div>
...
echo "<b>Cost per day - </b>" . $currencysymbol . $particulars[5] ."<br>";
?></td>
<td class="right"><?php echo $currencysymbol; ?><?php echo $rsbilling[4]; ?></td>
</tr>
</tbody>
</table>
</div>
