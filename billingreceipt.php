...
<div class="card-body">
	<div class="row mb-4">
			<div class="col-sm-12">
				<center>
				<h2>BVM Engineering College </h2>
				<div> (Anand, Gujarat - 388120)</div>
...
<br>
			...
			<div class="col-sm-12">
			<div style="font-size:16px;"><b>Received from Miss/Mr.  <u ><?php echo $rsadmission['name']; ?></u> Collected Amount <u >Rs.<?php echo $rsbilling[4]; ?></u>  from <u><?php echo date("d-M-Y",strtotime($rsadmission['start_date'])); ?></u>  to <u ><?php echo date("d-M-Y",strtotime($rsadmission['end_date'])); ?></u></b></div>
			</div>
	</div>
