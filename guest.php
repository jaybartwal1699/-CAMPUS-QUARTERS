...
if(isset($_POST['submit']))
{
	...
	if(mysqli_affected_rows($con) ==1 )
	{
		//echo "<SCRIPT>alert('Guest Registration Completed successfully..');</SCRIPT>";
...
<form action="" method="post" class="register-wthree" name="frmform" onsubmit="return validateform()">
	...
	<div class="form-group">
		...
		<input class="form-control" type="text" name="contactno" value="<?php echo $rsedit['contactno'];?>" placeholder="Enter Contact Number">
	</div>
