...
{
	swal({title: 'AKGEC Hostel..',text: msg, type: 'success'}).then(function() {  window.location =  pagename;});
}
</script>
...
?>
		<!-- header -->
		<header style="background-color:bisque;opacity: 0.6;filter: Alpha(opacity=50);height: 80px;">
