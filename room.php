...
<div class="title text-center mb-sm-5 mb-4">
				<h3 class="title-w3 text-bl text-center font-weight-bold">Add Room Or New Block</h3>
				<div class="arrw">
	...
	<div class="row">
		...
		<div class="container py-xl-5 py-lg-3">
			<!-- <div class="title text-center mb-sm-5 mb-4">
				<h3 class="title-w3 text-bl text-center font-weight-bold">Room 1</h3>
				<div class="arrw">
					<i  aria-hidden="true"></i>
				</div>
			</div> -->
...
<form action="" method="post" class="register-wthree" name="frmform" onsubmit="return validateform()">
	...
	<div class="form-group">
		...
		<select name="block_id" class="form-control" onchange="fun_load_fees_structure(this.value)">
	...
	<div class="form-group" id="div_feesstructure" ><?php include("jsfeesstructure.php"); ?></div>
...
<script>
function fun_load_fees_structure(block_id)
{
	$.get("jsfeesstructure.php?block_id="+block_id, function(data){
		$("#div_feesstructure").html(data);
	});
}
</script>